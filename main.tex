...
STAMPED takes a pragmatic approach toward these goals in which each property has a spectrum, from practical minimums---often what researchers are already doing---to aspirational ideals.
...
As complexity grows---multi-institutional collaborations with federated datasets, heterogeneous workflows spanning platforms, long-term reproducibility requirements---the same properties scale upward toward their ideal ends, guiding researchers toward more rigorous practices without requiring wholesale adoption of new tools.
STAMPED is not a compliance threshold to clear but an incremental framework: any research object can be evaluated against it, and any improvement along any dimension is meaningful.
...
As such, STAMPED complements formal computational workflow guidelines (e.g., FAIR4RS, RO-Crate) and facilitates the transition toward comprehensive workflow automation.
